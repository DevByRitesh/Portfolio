          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <p className="text-white">+91 7017711419</p>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/DevByRitesh"
                ...
                <a
                  href="https://www.linkedin.com/in/ritesh-verma-61926a300/"
                  className="w-10 h-10 bg-slate-700 rounded-lg flex items-center justify-center hover:bg-blue-600 transition-colors duration-300"
                >
