  ...
  const experiences = [
    {
      ...
      description: "Worked on developing and refining Python libraries, automating data collection, classification, and precise identification of fish diseases using machine learning algorithms.",
      skills: ["Python", "Machine Learning", "Data Science", "TensorFlow"]
    },
    {
      type: "work",
      title: "Full Stack Web Development Internship", 
      company: "IBM SkillsBuild & CaRKOX",
      period: "June 2024 - Aug 2024",
      description: "Developed responsive and interactive website 'Life Below Water' to promote awareness of Sustainable Development Goal 14, focusing on marine conservation.",
    ...
    },
    {
      ...
      company: "Raj Kumar Goel Institute of Technology and Management",
      period: "2021 - 2025",
